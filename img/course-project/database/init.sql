...
VALUES
    ...
    (
        ...
        'Этот материал пока не опубликован и сохранён как черновик. В нём собраны тезисы для устной защиты: почему выбрана текущая структура MVC, как работает роутер и каким образом проект использует данные из MySQL.',
        1,
        2,
        'draft',
        '2026-06-04 09:15:00'
